...
function perfect_portfolio_scripts(){
   ...
   if( get_theme_mod( 'ed_localgoogle_fonts',false ) && ! is_customize_preview() && ! is_admin() ){
        if ( get_theme_mod( 'ed_preload_local_fonts',false ) ) {
			perfect_portfolio_load_preload_local_fonts( perfect_portfolio_get_webfont_url( perfect_portfolio_fonts_url() ) );
        }
        wp_enqueue_style( 'perfect-portfolio-google-fonts', perfect_portfolio_get_webfont_url( perfect_portfolio_fonts_url() ) );
    }else{
...
function perfect_portfolio_admin_notice(){
    ...
    $dismissnonce   = wp_create_nonce( 'perfect_portfolio_admin_notice' );
        ...
        <div class="welcome-message notice notice-info">
            <div class="notice-wrapper">
                <div class="notice-text">
                    ...
                    <p><a href="<?php echo esc_url( admin_url( 'themes.php?page=perfect-portfolio-dashboard' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Go to the dashboard.', 'perfect-portfolio' ); ?></a></p>
                    <p class="dismiss-link"><strong><a href="?perfect_portfolio_admin_notice=1&_wpnonce=<?php echo esc_attr( $dismissnonce ); ?>"><?php esc_html_e( 'Dismiss', 'perfect-portfolio' ); ?></a></strong></p>
                </div>
            </div>
        </div>
    <?php }
...
function perfect_portfolio_update_admin_notice(){
    ...
    if ( isset( $_GET['perfect_portfolio_admin_notice'] ) && $_GET['perfect_portfolio_admin_notice'] = '1' && wp_verify_nonce( $_GET['_wpnonce'], 'perfect_portfolio_admin_notice' ) ) {
